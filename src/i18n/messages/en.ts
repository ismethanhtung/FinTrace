export const enMessages = {
    ...
    settingsPage: {
        ...
        twoFactorAuthenticatorHint:
            "Use Google Authenticator (or compatible TOTP app) to generate 6-digit verification codes.",
        setupGoogleAuthenticator: "Set up Google Authenticator",
        scanQrWithApp: "Scan this QR code in your authenticator app",
        twoFactorQrAlt: "Two-factor authentication QR code",
        twoFactorCodePlaceholder: "Enter 6-digit code",
        twoFactorDisablePlaceholder: "Enter current 6-digit code to disable",
        twoFactorEnabledAt: "2FA enabled at {date}",
        twoFactorExpiresAt: "Setup session expires at {date}",
        verifyAndEnable: "Verify and enable",
        verifyAndContinue: "Verify and continue",
        disableTwoFactor: "Disable 2FA",
        generateNewQr: "Generate new QR",
        twoFactorLoadFailed: "Failed to load 2FA status.",
        ...
        twoFactorGateDescription:
            "For your account security, enter your 6-digit authenticator code to continue.",
        signOut: "Sign out",
        activeSessions: "Active sessions",
        activeSessionsDesc: "2 devices currently logged in.",
        manageSessions: "Manage sessions",
        apiAccessTokens: "API access tokens (soon or not)",
    ...
    ticker: {
        ...
        signInToStar: "Sign in to star favorites.",
        signInToPin: "Sign in to pin favorites.",
        signInForFavoriteFilter: "Sign in to use the favorites filter.",
    ...
    liquidationPage: {
        title: "Dedicated liquidation stream",
        subtitle:
            "USD-M perps in real time via WebSocket. Public REST liquidation history from Binance is limited.",
        dataArchive: "Binance public data (historical files)",
    },
    liquidationPanel: {
        futuresOnly:
        ...
        bufferRows: "Buffer · {rows}/{max} rows",
        reconnect: "Reconnect",
        followSymbol:
        ...
        filterMatchShort: "{shown} / {received} rows",
        filterMatchTitle:
            "Rows matching current filters vs events received from stream",
        filterScope: "Scope",
        exportJson: "JSON",
        exportCsv: "CSV",
        exportHint:
            "Exports rows in the in-memory buffer (live since load / reconnect). Not an official exchange snapshot.",
        filterSymbol: "Symbol contains…",
        filterSide: "Liq side",
        sideAll: "All",
        sideLongLiq: "Long liq",
        sideShortLiq: "Short liq",
        sideLongHint: "Forced closes of longs (SELL in feed)",
        sideShortHint: "Forced closes of shorts (BUY in feed)",
        minNotional: "Min notional",
        minAny: "Any",
        topInBuffer: "Top by notional (buffer)",
        statTotal: "Total",
        statLong: "Long liq",
        statShort: "Short liq",
        contextMark: "Mark",
