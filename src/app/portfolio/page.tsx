                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="p-8 bg-secondary rounded-2xl border border-main flex flex-col justify-between">
                        <div>
                            ...
                            <div className="text-[42px] font-mono font-bold tracking-tighter">
                                $124,532.80
                            </div>
                        ...
                        <div className="mt-12 flex items-center space-x-6">
                            <div className="flex flex-col">
                                <span className="text-muted text-[11px] uppercase font-bold">
                                    Cash Balance
                                </span>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="text-[14px]">
                            {MOCK_ASSETS.map((asset) => (
                                <tr
                                    key={asset.id}
                                    className="border-b border-main last:border-0 hover:bg-secondary transition-colors"
                                >
