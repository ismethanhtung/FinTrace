...
import { useAppSettings, THEME_CYCLE, AppTheme } from '../context/AppSettingsContext';
import {
  Moon, Sun, RefreshCw, TrendingUp, Search,
  Palette,
} from 'lucide-react';
...
export default function App() {
  ...
  const onBottomHandleMouseDown = useCallback((e: React.MouseEvent) => {
